...
public abstract class MicroService implements Runnable {
    ...
    public final void run() {
        // Step 1: Register this MicroService with MessageBus
        ...
        while (!terminated) {
            ...
            if (msg instanceof Event){
                ...
                Callback<Event<?>> callback = (Callback<Event<?>>) callbacks.get(event.getClass());
                if (callback!=null){
                    callback.call(event);
                }
                ...
                Broadcast bcs = (Broadcast) msg;
                Callback<Broadcast> callback = (Callback<Broadcast>) callbacks.get(bcs.getClass());
                if (callback!=null){
                    callback.call(bcs);
                }
